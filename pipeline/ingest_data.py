...
@click.option("--year", default=2021, show_default=True, type=int, help="Taxi CSV year")
@click.option("--month", default=1, show_default=True, type=int, help="Taxi CSV month")
@click.option("--chunksize", default=100000, show_default=True, type=int, help="CSV chunk size for ingestion")
